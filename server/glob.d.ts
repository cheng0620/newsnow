...
declare module 'glob:./sources/{*.ts,**/index.ts}' {
  ...
  export const chaincatcher: typeof import('./sources/chaincatcher')
  ...
  export const qukuaizhoukan: typeof import('./sources/qukuaizhoukan')
  ...
  export const techflow: typeof import('./sources/techflow')
